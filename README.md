...
To build the final jar and optimize the DevOpsMaturity application for production, run:
...
Then navigate to [http://localhost:8033](http://localhost:8033) in your browser.
