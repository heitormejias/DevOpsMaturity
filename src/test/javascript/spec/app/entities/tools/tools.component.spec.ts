...
import { ToolsComponent } from 'app/entities/tools/tools.component';
import { ToolsService } from 'app/entities/tools/tools.service';
import { Tools } from 'app/shared/model/tools.model';

describe('Component Tests', () => {
  describe('Tools Management Component', () => {
    let comp: ToolsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ToolsComponent, '')
        .compileComponents();
