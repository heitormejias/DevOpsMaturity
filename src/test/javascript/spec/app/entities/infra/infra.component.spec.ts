  ...
  describe('Infra Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InfraComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.infras && comp.infras[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
